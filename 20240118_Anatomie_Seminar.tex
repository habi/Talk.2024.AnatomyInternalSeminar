...
\begin{frame}
 ...
 \only<2>{
	 	...
	 	\animategraphics[autoplay,loop,width=\paperwidth,every=\everyframe]{24}{./media/ZMK/transparent-slices-rcs/image0}{000}{457}%
	 		};%
	 \end{tikzpicture}%
	 }
\end{frame}
	...
	\frametitle{Many more teeth, but from Cichlids}
		...
		\begin{itemize}
			...
			\begin{column}{0.5\linewidth}
				...
				\includegraphics<7>[width=\imagewidth]{./images/EAWAG/voxelsizes.png}%
			\end{column}
		\end{columns}
\end{frame}
 ...
 \begin{frame}
 	\frametitle{Datasets}
\centering
		\includegraphics[height=\imageheight]{./images/EAWAG/animation.intro/1040160050}%
 \end{frame}

 \begin{frame}
 	\frametitle{Datasets}
\centering
 		\animategraphics[autoplay,loop,height=\imageheight,every=\everyframe]{24}{./images/EAWAG/animation.intro/104016}{0040}{0050}%
 \end{frame}

 \begin{frame}
 	\frametitle{Data wrangling by example: Cichlids}
 	\centering
 	\includegraphics<1>[height=\imageheight]{./images/EAWAG/Otolither_104016_head_01_Overview}%
 	\includegraphics<2>[height=\imageheight]{./images/EAWAG/Otolither_104016_head_02_GrayValues}%
 	\includegraphics<3>[height=\imageheight]{./images/EAWAG/Otolither_104016_head_03_GrayValuesRegion}%
 	\includegraphics<4>[height=\imageheight]{./images/EAWAG/Otolither_104016_head_04_GrayValuesSmoothed}%
 	\includegraphics<5>[height=\imageheight]{./images/EAWAG/Otolither_104016_head_05_Peaks}%
 	\includegraphics<6>[height=\imageheight]{./images/EAWAG/Otolither_104016_head_06_Peaks_All}%
 	\includegraphics<7>[height=\imageheight]{./images/EAWAG/Otolither_104016_head_07_ExtractedRegions}%
 	\includegraphics<8>[height=\imageheight]{./images/EAWAG/Otolither_104016_head_08_ExtractedRegionsMIPs}%
 	\includegraphics<9>[height=\imageheight]{./images/EAWAG/Otolither_104016_head_09_ExtractedOtolithMasked}%
