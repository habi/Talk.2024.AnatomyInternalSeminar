...
\begin{column}{0.5\linewidth}
  ...
  \includegraphics<1>[width=\imagewidth]{./media/cox7a/cut.5269C.png}%
	...
	\includegraphics<4>[width=0.5\imagewidth]{./media/cox7a/histogram.5268C.png}%
  \includegraphics<4>[width=0.5\imagewidth]{./media/cox7a/histogram.5269C.png}%
	\includegraphics<5->[height=\imageheight]{./media/cox7a/Volume_Boxplot.5268_5269.ThresholdedVolume.png}%
\end{column}
\end{columns}
 \end{frame}
