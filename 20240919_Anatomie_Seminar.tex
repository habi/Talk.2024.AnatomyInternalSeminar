...
\begin{frame}
	...
	\only<2>{%
		...
		%\begin{tikzpicture}[remember picture,overlay]%
			%\node at (current page.center) {%
				\animategraphics[autoplay,width=\imagewidth,every=\everyframe]{24}{./media/EAWAG/animation.head/104016.head.rec.animation.}{0481}{1680}%
			%};%
		%\end{tikzpicture}%
	}%
	\only<3>{%
		...
		%\begin{tikzpicture}[remember picture,overlay]%
			%\node at (current page.center) {%
				\animategraphics[autoplay,width=\imagewidth,every=\everyframe]{24}{./media/EAWAG/animation.head/104016.head.rec.animation.}{1681}{1920}%
			%};%
		%\end{tikzpicture}%
	}%
