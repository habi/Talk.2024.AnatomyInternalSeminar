...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}		
			Collaboration with \href{https://www.zmk.unibe.ch/}{zmk bern – Zahnmedizinische Kliniken}~\cite{Haberthuer2021},~\cite{Wolf2021}
			\begin{itemize}
 ...
 \only<2>{					  \node at (current page.center) [shift={(0,-4pt)}]{\includegraphics[,width=\paperwidth]{./media/ZMK/tooth045/transparent-slices-rcs/image0000}};%
 }
...
\begin{frame}
	\frametitle{Many more teeth, but from Cichlids}
			...
			\begin{column}{0.55\linewidth}
		 	Collaboration with team of \href{https://www.aqua.iee.unibe.ch/}{\emph{Aquatic Ecology \& Evolution}}, from the \href{https://www.iee.unibe.ch/}{Institute of Ecology and Evolution}~\cite{Haberthuer2023}
			HYPERCITE
		\begin{itemize}
...
\begin{frame}
	...
	\only<1>{%
		...
		% Show Otolith
		\begin{tikzpicture}[remember picture,overlay]%
			\node at (current page.center) [shift={(0,0)}]{%
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}		
			Collaboration with \emph{Developmental Biology and Regeneration} group of Nadia Mercader Huber~\cite{Garcia-Poyatos2024}
		HYPERCITE
			\begin{itemize}%
